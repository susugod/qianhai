...
$.ibo.formEditor = function (para) {
    ...
    this.getToSubmitData = function () {
        ...
        var jsonOjb = {
            ...
            ViewSort: this.View.ViewSort,                       // 页面种类 1：普通页面  2：从表页面  3：明细页面  4：数据选择页面
    ...
    this.SetDataSource = function () {
        ...
        $.ibo.openNewWin({
            ...
            hasTitle: true,
            title: "选择数据源",
            url: "../../views/select/selectTbName(1).html?TimeStamp=201604011320",
...
$.ibo.formEditor.Init = function () {
    ...
    $.ibo.formEditor.Flow_NoCondtionMenu.on("click", function () {
        $.ibo.openNewWin({
            ...
            url: "../../views/flow/edit.html?TimeStamp=201604011320&type=add&FlowID=0&ParentID=1&FlowType=1&ViewID=" + formEditor.View.ViewID + "&ViewName=" + encodeURI(formEditor.View.ViewName),
    ...
    $.ibo.formEditor.Flow_CondtionMenu.on("click", function () {
        $.ibo.openNewWin({
            ...
            url: "../../views/flow/edit.html?TimeStamp=201604011320&type=add&FlowID=0&ParentID=1&FlowType=2&ViewID=" + formEditor.View.ViewID + "&ViewName=" + encodeURI(formEditor.View.ViewName),
            callBackFun: function (data) {
                $.ibo.formEditor.Instance.CreateFlowInfoRow(data);
            }
        });
    ...
    $.ibo.formEditor.Flow_SingleMenu.on("click", function () {
        $.ibo.openNewWin({
            ...
            hasTitle: true,
            title: "新增自定义流程",
            url: "../../views/flow/editforsingle.html?TimeStamp=201604011320&ViewID=" + formEditor.View.ViewID + "&ViewName=" + encodeURIComponent(formEditor.View.ViewName),
            callBackFun: function (data) {
                $.ibo.formEditor.Instance.CreateFlowInfoRow(data);
            }
        });
    ...
    $.ibo.formEditor.Flow_Edit.on("click", function () {
        ...
        if (FlowType == "3") {
            ...
            url = "../../views/flow/editforsingle.html?TimeStamp=201604011320&";
        }
            // 非定义流程  共用一个页面
        else {
            width = $(window.top.document.body).width() - 6,
            ...
            url = "../../views/flow/edit.html?TimeStamp=201604011320&type=edit&ParentID=1&";
        }
